# SimpleSlotGameBackEndApplication
...
This application can be configured for Service Discovery and Configuration with the JHipster-Registry on application.yml file. For more information, read our documentation on [Service Discovery and Configuration with the JHipster-Registry][].
